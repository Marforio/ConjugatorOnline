...
const NON_DOUBLING = ['abandon','administer', 'allow', 'alter', 'anger', 'answer', 'benefit', 'bother', 'broaden', 'cater', 'color', 'combat', 'consider', 'counter', 'cover', 'deliver', 'develop',
    'differ', 'discover', 'edit', 'encounter', 'enter', 'exhibit', 'favor', 'focus', 'foster', 'frigthen', 'gather', 'happen', 'hasten', 'honor', 'inherit', 'interpret', 'lengthen', 'limit', 'listen', 'lower', 'master', 'market', 'minister', 'misinterpret',
