<!-- src/components/regret_machine/regret_machine_scenes/RegretMachineScene02_Results.vue -->
<template>
    ...
    <v-card class="mx-auto" max-width="900">
      <v-card-text>
        ...
        <div class="d-flex justify-center align-center mt-4 gap-5">
          ...
          <router-link :to="{ path: '/my-data', query: { tab: 'other-games', game: 'Regret Machine' } }">
