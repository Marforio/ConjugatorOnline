<!-- src/components/year_2040/year_2040_scenes/Year2040Scene02_Results.vue -->
<template>
    ...
    <v-card class="mx-auto" max-width="900">
      <v-card-text>
        ...
        <div class="results-scroll">
          ...
          >
            ...
            <div>
              ...
              <span v-if="r.out_of_time" class="text-caption ms-2">⏱ timed out</span>
            </div>
          </div>
        </div>
        ...
        <div class="d-flex justify-center align-center mt-4 gap-5">
          <v-btn @click="goToScene('Year2040Scene00_Start')">
            ▶️ Play Again
          </v-btn>
