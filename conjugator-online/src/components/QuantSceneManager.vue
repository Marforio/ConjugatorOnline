...
import QuantScene00_Start from './quant_scenes/QuantScene00_Start.vue'
...
export default {
  data() {
    return {
      scenes: {
        QuantScene00_Start,
        QuantScene01_Game,
        QuantScene02_Results,
      },
      currentScene: 'QuantScene00_Start', 
      gameSettings: null,
      results: null,
      totalTime: '',
      avgTime: '',
  ...
  methods: {
    ...
    handleStartGame(selections) {
      // selections should include: { variant: "countable"|"uncountable"|"all", numRounds: number }
