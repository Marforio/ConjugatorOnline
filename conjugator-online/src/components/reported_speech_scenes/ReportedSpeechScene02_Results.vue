<!-- src/components/reported_speech/reported_speech_scenes/ReportedSpeechScene02_Results.vue -->
<template>
    ...
    <v-card class="mx-auto" max-width="900">
      <v-card-text>
        ...
        <div class="d-flex justify-center align-center mt-4 gap-5">
          <v-btn @click="goToScene('ReportedSpeechScene01_Game')">
            ▶️ Play Again
          </v-btn>

          <router-link :to="{ path: '/dashboard', query: { tab: 'other-games', game: 'Reported Speech' } }">
