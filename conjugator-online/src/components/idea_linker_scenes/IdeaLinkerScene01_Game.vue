...
<template>
  <v-container fluid class="pa-4 d-flex justify-center">
    ...
    <v-card class="pt-4 px-4 pb-1" width="700" min-height="600" elevation="2">
          ...
          <v-card class="pa-3 my-4" elevation="2" variant="flat">
            <div class="d-flex ga-4">
              ...
              <div class="flex-grow-1">
                <div class="text-h6 font-weight-regular font-italic text-center my-5 mx-10" style="font-size: 1.5rem;">
                  {{ round.promptText }}
                </div>
                <div class="d-flex justify-center mb-2" style="margin-top: 10%;">
                  <v-chip
                  v-if="!round.variant"  
                  color="primary"
                    variant="flat"
              ...
              <div style="width: 240px;">
                ...
                <div v-if="usedLinkersList.length === 0" class="text-caption text-medium-emphasis">
                  None yet. Try to use a variety.
                </div>
                <div class="d-flex flex-wrap ga-2">
                  <v-chip
                    v-for="l in usedLinkersList"
                    :key="l"
                    size="small"
